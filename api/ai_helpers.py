...
def llm_generate_questions(product_title:str, template_prompt:str, product_attributes={}) -> list:
    ...
    return parse_output(parser, output_raw_text, product_title, product_attributes, template_prompt)


def parse_output(parser, raw_output, product_title, product_attributes, template_prompt):
    try: 
    ...
    try:
        ...
        prompt_value = prompt.format_prompt(product_title=product_title, product_attributes=product_attributes)
